...
public class AssetIndex {
	...
	public class AssetObject {
		...
		public boolean equals(Object o) {
			...
			if (this.compressedSize != that.compressedSize) return false;

			if (this.reconstruct != that.reconstruct) return false;

			if (this.size != that.size) return false;

			if ((this.compressedHash != null) ? !this.compressedHash.equals(that.compressedHash) : (that.compressedHash != null)) return false;
