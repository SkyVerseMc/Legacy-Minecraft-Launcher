	...
	protected <T extends Response> T makeRequest(URL url, Object input, Class<T> classOfT) throws AuthenticationException {
		...
		try {
			...
			if (StringUtils.isNotBlank(response.getError())) {
				...
				if ("UserMigratedException".equals(response.getCause())) throw new UserMigratedException(response.getErrorMessage());

				if (response.getError().equals("ForbiddenOperationException")) throw new InvalidCredentialsException(response.getErrorMessage());
