...
public class CurrentLaunchFeatureMatcher implements CompatibilityRule.FeatureMatcher {
	...
	public boolean hasFeature(String name, Object value) {
		...
		if (name.equals("is_demo_user")) return Objects.equal(Boolean.valueOf((this.auth.getSelectedProfile() == null)), value); 

		if (name.equals("has_custom_resolution")) return Objects.equal(Boolean.valueOf((this.profile.getResolution() != null)), value); 
